...
** @GET /constituencies/[constituency_id]/member_of_parliaments.xml@
** @GET /constituencies/[constituency_id]/member_of_parliaments.json@
* Get MPs by State
** @GET /states/[state_id]/member_of_parliaments.xml@
** @GET /states/[state_id]/member_of_parliaments.json@
* Get MP
** @GET /member_of_parliaments/[mp_id].xml@
** @GET /member_of_parliaments/[mp_id].json@
* Get MPs by Party
** @GET /parties/[party_id]/member_of_parliaments.xml@
** @GET /parties/[party_id]/member_of_parliaments.json@
